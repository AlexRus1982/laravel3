...
<template >
    <div  >
        <span class="container-data__row__text container-data__row__text_left">Единый телефон</span>
        <h1 class="shourum__title">
            8 (800) 511−1075</h1>

            <ul v-for="elem in citys" :key="elem.city" class="container-data__city">
           <li class="shourum__content-grey" style="list-style: none;"> 
            <div class="container__row">
    <div  class="shourum__container-data">
        <h3 class="container-data__city">{{ elem.city }}</h3>
    ...
    <button class="shourum__button" type="submit">Подробнее</button>
...
<div class="container__image"><span class="metr"> 256м</span><img  class="image" src="https://static.tildacdn.com/tild3165-6231-4261-b236-373132656435/artfabric_furniture_.jpg" alt="картинка"></div>
</li>
</ul>
<Contacts></Contacts>
...
<Sklad></Sklad>
  ...
  <style scoped>
  .container-data__row__text_left{
    text-align:left;
    display: flex;
    width: 100%;
  }
