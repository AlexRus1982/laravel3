<template>
    <div class="shourum__content-grey_contact">
        <h3 class="container-data__city">Контакты</h3>
        <span class="container-data__row__text">Менеджер по рекламациям: support@artfc.ru⠀</span>
