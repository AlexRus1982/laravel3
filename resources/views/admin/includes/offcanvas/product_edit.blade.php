<div 
    ...
    <div class="offcanvas-body">
        ...
        <div class="form-check mt-3 d-flex align-items-center">
            <input class="meta-checkbox form-check-input" type="checkbox" value="" id="ProductUseDefaultMeta" use-for="products-meta-section" table-data-product table-column-name="products_use_default_meta" checked>
            <label class="form-check-label ms-2" for="ProductUseDefaultMeta" style="margin-top: 4px;">Использовать Meta по умолчанию</label>
        </div>

        <div id="products-meta-section" class="section w-100 flex-column my-3 p-2 border">
            <div class="section-header d-flex ms-0 fw-bold">Товар</div>
            ...
            <div class="section-item d-flex flex-row">
                ...
                <div class="section-item-input">
                    <input type="text" table-data-product table-column-name="products_title" id="products-title">
                </div>
            </div>
            ...
            <div class="section-item d-flex flex-row">
                ...
                <div class="section-item-input">
                    <input type="text" table-data-product table-column-name="products_title_h1" id="products-title-H1">
                </div>
            </div>
            ...
            {{-- <div class="section-item d-flex flex-row">
                ...
                <div class="section-item-input">
                    <textarea table-data-product table-column-name="products_keywords" id="products-keywords"></textarea>
                </div>
            </div> --}}
            ...
            <div class="section-item d-flex flex-row">
                ...
                <div class="section-item-input">
                    <textarea table-data-product table-column-name="products_meta" id="products-meta"></textarea>
                </div>
            </div>

            <div class="section-item d-flex flex-row">
                <div class="section-item-title">Доп. описание</div>
                <div class="section-item-input">
                    <input type="text" table-data-product table-column-name="products_desc" id="products-desc">
                </div>
            </div>
