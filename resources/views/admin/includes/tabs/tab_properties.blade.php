...
<div class="tab-pane fade bg-light" id="nav-properties" role="tabpanel" aria-labelledby="nav-properties-tab" tabindex="0">
    <div id="properties-panel" class="d-flex flex-column w-100 p-2 bg-white shadow">
        <div class="area-title fw-bold ms-2 me-auto py-2 d-flex w-100">
            ...
            <div title="Добавить свойство" class="ms-auto me-3"><img class="add-button add-property" src="/public/images/round-plus.svg"></div>
        </div>
                        ...
                        foreach($properties as $property) {
                            ...
                            ?>
                                <div item-id="{{$property->id}}" class="table-property-item w-100 d-flex flex-row justify-content-between p-2" draggable="true">
                                    <div class="property-drag"><img src="/public/images/drag-button.svg" class="item-drag" draggable="false"></div>
                                    ...
                                    <div class="property-buttons">
                                        <img src="/public/images/edit-button.svg" class="property-button property-edit me-2">
                                        <img src="/public/images/list-button.svg" class="property-button property-list me-2">
                                        <img src="/public/images/close-button.svg" class="property-button property-delete">
                                    </div>
                                </div>
                            <?
                        }
