...
<head>
    ...
    <link rel="icon" href="/public/images/tools.ico" type="image/x-icon">

    <title>Панель администратора</title>

    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-iYQeCzEYFbKjA/T2uDLTpkwGzCiq6soy8tYaI1GyVh/UjpbCx/TYkiZhlZB6+fzT" crossorigin="anonymous">

    <link rel="stylesheet" href="/public/css/admin/admin_panel.css" />
...
<body>
    ...
    @include('admin.includes.offcanvas.tag_edit')
    @include('includes.messages-panel')

    <main class="min-vh-100 w-100">

        <div class="card text-center" style="box-shadow: 0px 5px 4px #0000FF7F; max-height: calc(100vh - 8px); overflow-y: clip;">
            <div class="card-header pb-0">
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <button class="nav-link" id="nav-export-tab" data-bs-toggle="tab" data-bs-target="#nav-export" type="button" role="tab" aria-controls="nav-export" aria-selected="false">Экспорт</button>
            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                {{--<!-- SEO -->--}}
                @include('admin.includes.tabs.tab_seo')

                {{--<!-- Экспорт -->--}}
                @include('admin.includes.tabs.tab_export')
    ...
    <script src="/public/js/nic-edit.js" type="text/javascript"></script>
