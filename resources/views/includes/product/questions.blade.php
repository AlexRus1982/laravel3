<div class="block-wrapper " style="width: 1400px;margin-left:auto;margin-right:auto; border-top: 1px solid var(--block-divider-liner-color);">
    <div class="questions-block py-2  d-flex flex-column justify-content-start" >
...
<div class="offcanvas-header">
    ...
    <div class="form-outline">
      <textarea type="text" class="form-control" name="validationCustom03" id="validationCustom03" required ></textarea>
      <label for="validationCustom03" class="form-label">Вопрос</label>
      <div class="invalid-feedback"></div>
    </div>
  </div>
  <div class="col-md-12 mt-10">
    <div class="form-outline">
      <input type="text" class="form-control" name="validationCustom03" id="validationCustom03" required />
