        ...
        <div class="d-flex flex-row w-100 justify-content-start flex-wrap pb-3 mb-4">
            <?php
                foreach ($categories as $category) {
                    ...
                    ?>
                        <a class="category-card" rel="noopener noreferrer" href="/categories/{{$category->category_url}}" style="text-decoration: none; color: #000000; border:none; background: none;">
